      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center relative z-10">
        <div className="lg:w-1/2 mb-12 lg:mb-0">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
            Instalação e Manutenção de Ar-Condicionado E Eletrica <span className="text-yellow-400 font-black">Excelência Rocha</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-xl">
            A Eletro Rocha garante o clima perfeito para sua casa ou empresa, Trabalhanmso tambem com eletrica. Técnicos certificados, atendimento imediato e preço justo em toda Santa Catarina.
          </p>
